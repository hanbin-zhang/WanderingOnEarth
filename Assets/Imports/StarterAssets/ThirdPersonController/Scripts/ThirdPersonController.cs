...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (PlayerFollowCamera3rdPersonFollow == null)
            {
                PlayerFollowCamera3rdPersonFollow = PlayerFollowCamera.GetCinemachineComponent<Cinemachine3rdPersonFollow>();
            }
        }
        ...
        private void Zoom()
        {
            float newDistance = PlayerFollowCamera3rdPersonFollow.CameraDistance + _input.zoom * ZoomSensitive;
            PlayerFollowCamera3rdPersonFollow.CameraDistance = Mathf.Clamp(newDistance, 1, 10);
        }
        ...
        private void Move()
        {
            ...
            if (_hasAnimator)
            {
                ...
                float factor = Mathf.Lerp(MoveAnimationFactor, SprintAnimationFactor,  (_speed - MoveSpeed) / (SprintSpeed - MoveSpeed));
