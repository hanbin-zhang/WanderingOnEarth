...
struct TessellationFactors
{
 ...
 //the original vertices structure
struct Attributes
{
 ...
 //start with the extra vertex struct; Instead of : POSITION, notice how it says INTERNALTESSPOS
struct ControlPoint
{
...
//the vert program of pre tesselltion,The mesh data of the original vertex struct
...
float CalcDistanceTessFactor(float4 vertex, float minDist, float maxDist, float tess)
{
 ...
 //we do the actual tessellation in patchConstantFunction, as described above the hull program. It's  set up to fade over distance from the camera.
